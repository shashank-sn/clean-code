...
6. Require concrete evidence for review findings. A review may return zero findings only with explicit scope, coverage, and limitations; zero findings never proves correctness.
