...
var builtinPlaybooks = map[string]Playbook{
	...
	"feature-delivery": {
		...
		MinimumRoles:     []string{"clean-plan", "clean-build", "clean-test", "clean-simplify", "clean-verify", "clean-review"},
	...
	"refactor": {
		...
		MinimumRoles:     []string{"clean-refactor", "clean-simplify", "clean-test", "clean-verify", "clean-review"},
	...
	"release-readiness": {
		...
		MinimumRoles:     []string{"clean-verify", "clean-review", "clean-ship", "clean-audit"},
		MinimumEvidence:  []string{"verification-report", "review-input", "spot-check-or-gap", "audit-receipt-or-NOT_RUN"},
		ArenaWarranted:   "no",
