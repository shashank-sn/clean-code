...
- `study --manifest FILE --case-corpus FILE --oracle-corpus FILE --model-config FILE --results FILE --results-signature FILE --trusted-public-key FILE`: verify committed study inputs, signed outcomes, paired execution identities, and the performance-claim gate.
