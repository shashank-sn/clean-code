...
Statuses retain their exact meaning: `PASS`, `FAIL`, `NOT_AVAILABLE`, `NOT_CONFIGURED`, `NOT_RUN`, and `ERROR`. Optional missing tools stay visible as unavailable or unconfigured results.
